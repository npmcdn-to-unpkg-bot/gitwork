...
angular.module('myApp.filter_orderby', ['ngRoute'])

	.config(['$routeProvider', function($routeProvider) {
		$routeProvider.when('/filter_orderby', {
			templateUrl: 'filter_orderby/filter_orderby.html',
			controller: 'filter_orderby'
		});
	}])

	.controller('filter_orderby', function($scope) {
		$scope.members = [
